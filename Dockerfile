...
RUN mkdir -p /go/src/github.com/feildrixliemdra/go-shorten


WORKDIR /go/src/github.com/feildrixliemdra/go-shorten
...
ENV BUILDDIR=/go/src/github.com/feildrixliemdra/go-shorten
ENV PROJECT_DIR=/opt/go-shorten
